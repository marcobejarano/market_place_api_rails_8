...
class Api::V1::OrdersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should forbid show orders for unlogged users" do
    get api_v1_orders_url, as: :json
    assert_response :forbidden
  end

  test "should show orders for logged users" do
  ...
  test "should forbid create order for unlogged user" do
  ...
  test "should create order with two produts and placements" do
